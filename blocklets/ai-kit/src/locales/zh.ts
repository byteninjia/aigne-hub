  ...
  config: {
    ...
    modelRates: {
      ...
      form: {
        ...
        inputRate: {
          label: '输入 AIC 消耗/Token',
          placeholder: '0.005',
          required: '输入费率是必填项',
        },
        outputRate: {
          label: '输出 AIC 消耗/Token',
          placeholder: '0.015',
          required: '输出费率是必填项',
        },
        providers: {
      ...
      configInfo: {
        ...
        tokenConsumption: '每 Token 消耗 AIC 数量',
        creditPriceDesc: '1 个 AIC 的价格（美元）',
        profitMarginDesc: '在成本基础上的加价百分比',
        modelCostDesc: 'AI 提供商对该模型每 Token 的实际收费',
        aicRateConfig: 'AIC 费率配置',
        inputTokenConsumption: '每个输入 Token 消耗的 AIC 数量',
        outputTokenConsumption: '每个输出 Token 消耗的 AIC 数量',
        ...
        explanation: {
          ...
          formulaExplain: '根据模型实际成本和目标利润率自动计算每 Token 消耗的 AIC 数量',
