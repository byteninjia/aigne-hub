  ...
  config: {
    ...
    modelRates: {
      ...
      form: {
        ...
        inputRate: {
          label: 'Input AHC Per Token',
          placeholder: '0',
          required: 'Input is required',
        },
        outputRate: {
          label: 'Output AHC Per Token',
          placeholder: '0',
      ...
      configInfo: {
        ...
        inputTokenConsumption: 'AHC consumption per input token',
        outputTokenConsumption: 'AHC consumption per output token',
        ...
        explanation: {
          ...
          creditExplain: 'AHC is the billing unit used for AI services',
          formulaExplain:
