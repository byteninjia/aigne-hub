  ...
  config: {
    ...
    modelRates: {
      ...
      form: {
        ...
        inputRate: {
          label: '输入 AHC 消耗 / Token',
          placeholder: '0',
          required: '输入费率是必填项',
        },
        outputRate: {
          label: '输出 AHC 消耗 / Token',
          placeholder: '0',
          required: '输出费率是必填项',
        },
        providers: {
      ...
      configInfo: {
        ...
        tokenConsumption: '每 Token 消耗 AHC 数量',
        creditPriceDesc: '1 个 AHC 的价格（美元）',
        profitMarginDesc: '在成本基础上的加价百分比',
        modelCostDesc: 'AI 提供商对该模型每 Token 的实际收费',
        aicRateConfig: 'AHC 费率配置',
        inputTokenConsumption: '每个输入 Token 消耗的 AHC 数量',
        outputTokenConsumption: '每个输出 Token 消耗的 AHC 数量',
